...
public:
  ...
  void compress(const IntegerCaloSamples& ics, const std::vector<int>& fineGrain, HcalUpgradeTriggerPrimitiveDigi& digi) const;
  void compress(const std::vector<int>& timingbit, HcalUpgradeTriggerPrimitiveDigi& digi) const;
