 ...
 */
    ...
    // As of 2021: https://cmshcal.docs.cern.ch/hcos/crateFedMap/
    ...
    std::map<unsigned int, unsigned int> const fed2crate_map = {
        ...
        {1128, 26}, {1129, 26}, {1134, 38}, {1135, 38}, {1140, 24}, {1141, 20}, {1142, 21}, {1143, 25}, {1144, 31},
        {1145, 35}, {1146, 37}, {1147, 34}, {1148, 30}, {1136, 28},
    };

    std::vector<unsigned int> const fedList = {
        724,  725,  726,  727,  728,  729,  730,  731,  1100, 1101, 1102, 1103, 1104, 1105, 1106, 1107, 1108,
        1109, 1110, 1111, 1112, 1113, 1114, 1115, 1116, 1117, 1118, 1119, 1120, 1121, 1122, 1123, 1124, 1125,
        1126, 1127, 1128, 1129, 1134, 1135, 1140, 1141, 1142, 1143, 1144, 1145, 1146, 1147, 1148, 1136};
    std::vector<unsigned int> const fedListuTCA = {1100, 1101, 1102, 1103, 1104, 1105, 1106, 1107, 1108, 1109, 1110,
                                                   1111, 1112, 1113, 1114, 1115, 1116, 1117, 1118, 1119, 1120, 1121,
                                                   1122, 1123, 1124, 1125, 1126, 1127, 1128, 1129, 1134, 1135, 1140,
                                                   1141, 1142, 1143, 1144, 1145, 1146, 1147, 1148, 1136};
    ...
    std::vector<unsigned int> const crateList = {3,  6,  7,  13, 20, 21, 22, 23, 24, 25, 26,
                                                 27, 29, 30, 31, 32, 34, 35, 37, 38, 28};
    std::vector<unsigned int> const crateListuTCA = {
        20, 21, 22, 23, 24, 25, 26, 27, 29, 30, 31, 32, 34, 35, 37, 38, 28};
