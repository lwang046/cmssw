...
void OnlineDQMDigiAD::InitializeState()
{
    ...
    std::fill(input_model_state_memory_e_0_0.begin(), input_model_state_memory_e_0_0.end(), float(0.0)); // init model memory states-encoder_layer_0_state_0 to zero
    ...
    std::fill(input_model_state_memory_d_0_0.begin(), input_model_state_memory_d_0_0.end(), float(0.0)); // init model memory states-decoder_layer_0_state_0 to zero
    std::fill(input_model_state_memory_d_0_1.begin(), input_model_state_memory_d_0_1.end(), float(0.0)); // init model memory states-decoder_layer_0_state_1 to zero
    std::fill(input_model_state_memory_d_1_0.begin(), input_model_state_memory_d_1_0.end(), float(0.0)); // init model memory states-decoder_layer_1_state_0 to zero
    std::fill(input_model_state_memory_d_1_1.begin(), input_model_state_memory_d_1_1.end(), float(0.0)); // init model memory states-decoder_layer_1_state_1 to zero
    ...
    model_state_refresh_counter = 1; // DQM multithread returns non-sequential LS. Hence, the model will not keep states (experimental)
}
...
std::vector<std::vector<float>> OnlineDQMDigiAD::Map1DTo2DVector(const std::vector<float> &input_1d_vec, const int numSplits)
{
...
std::vector<float> OnlineDQMDigiAD::PrepareONNXDQMMapVectors(const std::vector<std::vector<float>> &digiHcal2DHist_depth_1,
                                                             ...
                                                             const std::vector<std::vector<float>> &digiHcal2DHist_depth_7)
{
    ...
    digi3DHistVector_serialized.insert(digi3DHistVector_serialized.end(), digiHcalDHist_serialized_depth_1.begin(), digiHcalDHist_serialized_depth_1.end());

    std::vector<float> digiHcalDHist_serialized_depth_2 = Serialize2DVector(digiHcal2DHist_depth_2);
    digi3DHistVector_serialized.insert(digi3DHistVector_serialized.end(), digiHcalDHist_serialized_depth_2.begin(), digiHcalDHist_serialized_depth_2.end());

    std::vector<float> digiHcalDHist_serialized_depth_3 = Serialize2DVector(digiHcal2DHist_depth_3);
    digi3DHistVector_serialized.insert(digi3DHistVector_serialized.end(), digiHcalDHist_serialized_depth_3.begin(), digiHcalDHist_serialized_depth_3.end());

    std::vector<float> digiHcalDHist_serialized_depth_4 = Serialize2DVector(digiHcal2DHist_depth_4);
    digi3DHistVector_serialized.insert(digi3DHistVector_serialized.end(), digiHcalDHist_serialized_depth_4.begin(), digiHcalDHist_serialized_depth_4.end());

    std::vector<float> digiHcalDHist_serialized_depth_5 = Serialize2DVector(digiHcal2DHist_depth_5);
    digi3DHistVector_serialized.insert(digi3DHistVector_serialized.end(), digiHcalDHist_serialized_depth_5.begin(), digiHcalDHist_serialized_depth_5.end());

    std::vector<float> digiHcalDHist_serialized_depth_6 = Serialize2DVector(digiHcal2DHist_depth_6);
    digi3DHistVector_serialized.insert(digi3DHistVector_serialized.end(), digiHcalDHist_serialized_depth_6.begin(), digiHcalDHist_serialized_depth_6.end());
    
    std::vector<float> digiHcalDHist_serialized_depth_7 = Serialize2DVector(digiHcal2DHist_depth_7);
    digi3DHistVector_serialized.insert(digi3DHistVector_serialized.end(), digiHcalDHist_serialized_depth_7.begin(), digiHcalDHist_serialized_depth_7.end());

    return digi3DHistVector_serialized;
}

std::vector<std::vector<std::vector<float>>> OnlineDQMDigiAD::ONNXOutputToDQMHistMap(const std::vector<std::vector<float>> &ad_model_output_vectors, const int selOutputIdx)
{
...
std::vector<std::vector<float>> OnlineDQMDigiAD::Inference(std::vector<float> &digiHcalMapTW, const std::vector<float> &numEvents, const std::vector<float> &adThr, std::vector<float> &input_model_state_memory_e_0_0, std::vector<float> &input_model_state_memory_e_0_1, std::vector<float> &input_model_state_memory_e_1_0, std::vector<float> &input_model_state_memory_e_1_1,
                                std::vector<float> &input_model_state_memory_d_0_0, std::vector<float> &input_model_state_memory_d_0_1, std::vector<float> &input_model_state_memory_d_1_0, std::vector<float> &input_model_state_memory_d_1_1)
{
    ...
    CPPUNIT_ASSERT_NO_THROW(outputs = ort_mSession.run(input_names,
                                                       input_values,
                                                       {},
                                                       output_names,
                                                       batch_size));
...
std::vector<std::vector<float>> OnlineDQMDigiAD::Inference_CMSSW(const std::vector<std::vector<float>> &digiHcal2DHist_depth_1,
                                    ...
                                    const std::vector<std::vector<float>> &digiHcal2DHist_depth_5,
                                    const std::vector<std::vector<float>> &digiHcal2DHist_depth_6,
                                    const std::vector<std::vector<float>> &digiHcal2DHist_depth_7, const float LS_numEvents, const float flagDecisionThr)
    ...
    std::vector<std::vector<float>>
        output_tensors = Inference(digiHcalMapTW, numEvents, adThr,
                                                    input_model_state_memory_e_0_0, input_model_state_memory_e_0_1, input_model_state_memory_e_1_0, input_model_state_memory_e_1_1,
                                                    input_model_state_memory_d_0_0, input_model_state_memory_d_0_1, input_model_state_memory_d_1_0, input_model_state_memory_d_1_1);
    ...
    {
        std::string output_names_startstr = output_names[i].substr(2, state_output_name_tag.length()); // Extract the same number of characters as str2 from mOutputNames
